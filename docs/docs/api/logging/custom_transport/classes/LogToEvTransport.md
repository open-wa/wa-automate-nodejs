...
> **new LogToEvTransport**(`opts`?): [`LogToEvTransport`](/api/logging/custom_transport/classes/LogToEvTransport.md)
...
The buffered data will be flushed when either the [uncork](/api/logging/custom_transport/classes/LogToEvTransport.md#uncork) or [end](/api/logging/custom_transport/classes/LogToEvTransport.md#end) methods are called.
...
Calling the [write](/api/logging/custom_transport/classes/LogToEvTransport.md#write) method after calling [end](/api/logging/custom_transport/classes/LogToEvTransport.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](/api/logging/custom_transport/classes/LogToEvTransport.md#defaultmaxlisteners).
...
The `writable.uncork()` method flushes all data buffered since [cork](/api/logging/custom_transport/classes/LogToEvTransport.md#cork) was called.
...
recommended to encapsulate the logic into a `Readable` and use [pipe](/api/logging/custom_transport/classes/LogToEvTransport.md#pipe). However, if calling `write()` is preferred, it is
