...
> **new NoOpTransport**(`opts`?): [`NoOpTransport`](/api/logging/custom_transport/classes/NoOpTransport.md)
...
The buffered data will be flushed when either the [uncork](/api/logging/custom_transport/classes/LogToEvTransport.md#uncork) or [end](/api/logging/custom_transport/classes/NoOpTransport.md#end) methods are called.
...
Calling the [write](/api/logging/custom_transport/classes/NoOpTransport.md#write) method after calling [end](/api/logging/custom_transport/classes/NoOpTransport.md#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](/api/logging/custom_transport/classes/NoOpTransport.md#defaultmaxlisteners).
...
recommended to encapsulate the logic into a `Readable` and use [pipe](/api/logging/custom_transport/classes/NoOpTransport.md#pipe). However, if calling `write()` is preferred, it is
