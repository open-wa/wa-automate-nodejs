...
[`Collector`](/api/structures/Collector/classes/Collector.md).[`clearInterval`](/api/structures/Collector/classes/Collector.md#clearinterval)
...
[`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)
