...
> **editProduct**(`productId`, `name`?, `price`?, `currency`?, `images`?, `description`?, `url`?, `internalId`?, `isHidden`?): `Promise`\<[`Product`](/api/api/model/product/interfaces/Product.md)\>
...
> **forceUpdateConnectionState**(`killBeforeReconnect`?): `Promise`\<[`STATE`](/api/api/model/enumerations/STATE.md)\>
...
• **messages**: [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md) \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)[]
...
> **getConfig**(): [`ConfigObject`](/api/api/model/config/interfaces/ConfigObject.md)
...
> **getMessageInfo**(`messageId`): `Promise`\<[`MessageInfo`](/api/api/model/message/interfaces/MessageInfo.md)\>
...
`Promise`\<[`Order`](/api/api/model/product/interfaces/Order.md)\>
...
`Promise`\<`string` \| `number` \| `boolean` \| [`Chat`](/api/api/model/chat/type-aliases/Chat.md)\>
...
> **loadEarlierMessages**(`contactId`): `Promise`\<[`Message`](/api/api/model/message/interfaces/Message.md)[]\>
...
> **postTextStatus**(`text`, `textRgba`, `backgroundRgba`, `font`): `Promise`\<`string` \| `boolean` \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
> **sendPoll**(`to`, `name`, `options`, `quotedMsgId`?, `allowMultiSelect`?): `Promise`\<[`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>

Send a poll to a group chat

#### Parameters

• **to**: [`GroupChatId`](/api/api/model/aliases/type-aliases/GroupChatId.md)
...
> **sendProduct**(`chatId`, `productId`): `Promise`\<[`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
> **sendPtt**(`to`, `file`, `quotedMsgId`?): `Promise`\<[`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
> **sendRawWebpAsSticker**(`to`, `webpBase64`, `animated`): `Promise`\<`string` \| `boolean` \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
• **webpBase64**: [`Base64`](/api/api/model/aliases/type-aliases/Base64.md)
...
> **sendRawWebpAsStickerAsReply**(`to`, `messageId`, `webpBase64`, `animated`): `Promise`\<`string` \| `boolean` \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
> **sendReplyWithMentions**(`to`, `content`, `replyMessageId`, `hideTags`?, `mentions`?): `Promise`\<`boolean` \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
• **replyMessageId**: [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)
...
• **mentions?**: [`ContactId`](/api/api/model/aliases/type-aliases/ContactId.md)[]
...
> **sendStickerfromUrl**(`to`, `url`, `requestConfig`, `stickerMetadata`?): `Promise`\<`string` \| `boolean` \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
> **sendStickerfromUrlAsReply**(`to`, `url`, `messageId`, `requestConfig`, `stickerMetadata`?): `Promise`\<`boolean` \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
> **sendText**(`to`, `content`): `Promise`\<`boolean` \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
> **sendTextWithMentions**(`to`, `content`, `hideTags`?, `mentions`?): `Promise`\<`boolean` \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
> **sendVideoAsGif**(`to`, `file`, `filename`, `caption`, `quotedMsgId`?, `requestConfig`?): `Promise`\<[`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
> **sendYoutubeLink**(`to`, `url`, `text`, `thumbnail`?, `quotedMsgId`?, `customSize`?): `Promise`\<`boolean` \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
• **ephemeral**: `boolean` \| [`EphemeralDuration`](/api/api/model/chat/type-aliases/EphemeralDuration.md)
...
• **chatState**: [`ChatState`](/api/api/model/chat/enumerations/ChatState.md)
...
> **tagEveryone**(`groupId`, `content`, `hideTags`?, `formatting`?, `messageBeforeTags`?): `Promise`\<`boolean` \| [`MessageId`](/api/api/model/aliases/type-aliases/MessageId.md)\>
...
• **callbackToTest**: [`SimpleListener`](/api/api/model/events/enumerations/SimpleListener.md)
...
> **updateWebhook**(`webhookId`, `events`): `Promise`\<`false` \| [`Webhook`](/api/api/model/config/interfaces/Webhook.md)\>
