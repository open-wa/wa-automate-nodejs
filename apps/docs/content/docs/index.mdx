...
Use these docs to start a WhatsApp session and connect it to your app or helpdesk. Use the API reference to find exact methods.
...
- **Node.js** >= 22.21.1
- **npm** for released packages, or **pnpm 11.9.0** for repo development
...
# Testing: use the v5 alpha dist-tag
...
- Use **[Quick start](/docs/getting-started/quickstart)** if you want to start the API, authenticate WhatsApp, and send your first message.
...
<Callout type="danger">
This project is unofficial and has no affiliation with WhatsApp or Meta. You accept the risk when you use it. When you use this project, you agree to the Terms of Service.
</Callout>

- Automation tools can cause an account restriction or ban
