...
This project is unofficial and has no affiliation with WhatsApp or Meta. Automation tools can cause an account restriction or ban. You accept this risk when you use the tools.
</Callout>
...
These are approximate limits observed by the community. WhatsApp does not publish official limits and they can change without notice.
...
1. **Temporary block**: WhatsApp can temporarily prevent you from sending messages
2. **Warning message**: You can receive a warning about automated behavior
...
Add random delays to prevent detectable patterns:
...
5. **Use a different account** for automation when necessary
