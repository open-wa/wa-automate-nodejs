...
Once you have built a plugin, you can want to share it with others. This guide covers packaging, publishing, and documentation best practices.
...
- **`name`**, Use a scoped name (`@myorg/my-plugin`) to prevent collisions
...
If your plugin uses session-specific data, test it with multiple sessions running simultaneously to make sure there are no conflicts.
