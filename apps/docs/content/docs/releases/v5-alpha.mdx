...
description: Changes in @open-wa v5.0.0-alpha.0, who can test it, and how to do a safe test.
---
...
- The project is a v5 monorepo with separate packages for the runtime, API, schema, browser drivers, plugins, and integrations.
...
For production workloads, stay on v4:
