---
title: Quick Start
description: Go from zero to your first sent message in under 5 minutes.
---

# Quick Start

Go from zero to your first sent WhatsApp message in under 5 minutes.
...
You will see terminal output showing:
...
If you started the API with `--api-key`, include it in the header:
