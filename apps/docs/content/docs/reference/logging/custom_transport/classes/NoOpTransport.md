...
> **new NoOpTransport**(`opts`?): [`NoOpTransport`](/docs/reference/logging/custom_transport/classes/NoOpTransport)
...
[`NoOpTransport`](/docs/reference/logging/custom_transport/classes/NoOpTransport)
...
The buffered data will be flushed when either the [uncork](/docs/reference/logging/custom_transport/classes/LogToEvTransport#uncork) or [end](/docs/reference/logging/custom_transport/classes/NoOpTransport#end) methods are called.
...
Calling the [write](/docs/reference/logging/custom_transport/classes/NoOpTransport#write) method after calling [end](/docs/reference/logging/custom_transport/classes/NoOpTransport#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](/docs/reference/logging/custom_transport/classes/NoOpTransport#defaultmaxlisteners).
...
recommended to encapsulate the logic into a `Readable` and use [pipe](/docs/reference/logging/custom_transport/classes/NoOpTransport#pipe). However, if calling `write()` is preferred, it is
