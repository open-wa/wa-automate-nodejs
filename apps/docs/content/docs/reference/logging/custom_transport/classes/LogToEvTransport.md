...
> **new LogToEvTransport**(`opts`?): [`LogToEvTransport`](/docs/reference/logging/custom_transport/classes/LogToEvTransport)
...
[`LogToEvTransport`](/docs/reference/logging/custom_transport/classes/LogToEvTransport)
...
The buffered data will be flushed when either the [uncork](/docs/reference/logging/custom_transport/classes/LogToEvTransport#uncork) or [end](/docs/reference/logging/custom_transport/classes/LogToEvTransport#end) methods are called.
...
Calling the [write](/docs/reference/logging/custom_transport/classes/LogToEvTransport#write) method after calling [end](/docs/reference/logging/custom_transport/classes/LogToEvTransport#end) will raise an error.
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](/docs/reference/logging/custom_transport/classes/LogToEvTransport#defaultmaxlisteners).
...
The `writable.uncork()` method flushes all data buffered since [cork](/docs/reference/logging/custom_transport/classes/LogToEvTransport#cork) was called.
...
recommended to encapsulate the logic into a `Readable` and use [pipe](/docs/reference/logging/custom_transport/classes/LogToEvTransport#pipe). However, if calling `write()` is preferred, it is
