...
// namespaced form: client.groups.addParticipant(...)
```
...
// namespaced form: client.groups.approveJoinRequest(...)
```
...
// namespaced form: client.groups.create(...)
```
...
// namespaced form: client.groups.demoteParticipant(...)
```
...
// namespaced form: client.groups.getAll(...)
```
...
// namespaced form: client.groups.getAdmins(...)
```
...
// namespaced form: client.groups.getInfo(...)
```
...
// namespaced form: client.groups.getInviteLink(...)
```
...
// namespaced form: client.groups.getMembers(...)
```
...
// namespaced form: client.groups.getMemberIds(...)
```
...
// namespaced form: client.groups.getKicked(...)
```
...
// namespaced form: client.groups.join(...)
```
...
// namespaced form: client.groups.leave(...)
```
...
// namespaced form: client.groups.promoteParticipant(...)
```
...
// namespaced form: client.groups.rejectJoinRequest(...)
```
...
// namespaced form: client.groups.removeParticipant(...)
```
...
// namespaced form: client.groups.revokeInviteLink(...)
```
...
// namespaced form: client.groups.setDescription(...)
```
...
// namespaced form: client.groups.setEditAdminsOnly(...)
```
...
// namespaced form: client.groups.setIcon(...)
```
...
// namespaced form: client.groups.setTitle(...)
```
...
// namespaced form: client.groups.setAdminsOnly(...)
```
