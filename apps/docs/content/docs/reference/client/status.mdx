...
// namespaced form: client.status.deleteAll(...)
```
...
// namespaced form: client.status.delete(...)
```
...
// namespaced form: client.status.getAll(...)
```
...
// namespaced form: client.status.postImage(...)
```
...
// namespaced form: client.status.postText(...)
```
...
// namespaced form: client.status.postVideo(...)
```
