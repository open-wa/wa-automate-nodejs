...
> **new Collection**\<`K`, `V`\>(`entries`?): [`Collection`](/docs/reference/structures/Collector/classes/Collection)\<`K`, `V`\>
...
[`Collection`](/docs/reference/structures/Collector/classes/Collection)\<`K`, `V`\>
...
> **new Collection**\<`K`, `V`\>(`iterable`?): [`Collection`](/docs/reference/structures/Collector/classes/Collection)\<`K`, `V`\>
