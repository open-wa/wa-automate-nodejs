...
> **new Collector**(`filter`, `options`): [`Collector`](/docs/reference/structures/Collector/classes/Collector)

#### Parameters

• **filter**: [`CollectorFilter`](/docs/reference/structures/Collector/type-aliases/CollectorFilter)\<`any`\>
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](/docs/reference/structures/Collector/classes/Collector#defaultmaxlisteners).
