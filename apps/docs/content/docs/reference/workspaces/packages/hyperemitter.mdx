---
title: "@open-wa/hyperemitter"
description: "HyperEmitter: high-performance, schema-driven event emitter for the open-wa v5 stack."
---

> `apps/docs/scripts/gen-workspace-readme-docs.js` generated this page from `packages/hyperemitter/README.md`. Do not edit this page directly.
