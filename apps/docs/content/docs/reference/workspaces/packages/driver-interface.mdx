---
title: "@open-wa/driver-interface"
description: "Browser driver abstraction interfaces for open-wa"
---

> `apps/docs/scripts/gen-workspace-readme-docs.js` generated this page from `packages/driver-interface/README.md`. Do not edit this page directly.
