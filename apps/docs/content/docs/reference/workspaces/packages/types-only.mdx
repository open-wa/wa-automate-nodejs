---
title: "@open-wa/wa-automate-types-only"
description: "Lightweight type-only re-exports from @open-wa/schema — zero runtime dependencies"
---

> `apps/docs/scripts/gen-workspace-readme-docs.js` generated this page from `packages/types-only/README.md`. Do not edit this page directly.
