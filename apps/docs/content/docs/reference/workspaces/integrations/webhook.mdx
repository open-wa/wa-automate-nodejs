---
title: "@open-wa/integration-webhook"
description: "Webhook delivery integration plugin for open-wa"
---

> `apps/docs/scripts/gen-workspace-readme-docs.js` generated this page from `integrations/webhook/README.md`. Do not edit this page directly.
