---
title: "@open-wa/integration-s3"
description: "S3/Cloud storage integration plugin for open-wa"
---

> `apps/docs/scripts/gen-workspace-readme-docs.js` generated this page from `integrations/s3/README.md`. Do not edit this page directly.
