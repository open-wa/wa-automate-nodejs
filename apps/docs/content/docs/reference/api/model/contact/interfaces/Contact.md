...
> `optional` **businessProfile**: [`BusinessProfile`](/docs/reference/api/model/contact/interfaces/BusinessProfile)
...
> **msgs**: [`Message`](/docs/reference/api/model/message/interfaces/Message)[]
...
> **id**: [`Id`](/docs/reference/api/model/id/interfaces/Id)
