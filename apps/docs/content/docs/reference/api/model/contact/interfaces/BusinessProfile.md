...
> **businessHours**: [`BusinessHours`](/docs/reference/api/model/contact/interfaces/BusinessHours)
...
> **categories**: [`BizCategory`](/docs/reference/api/model/contact/interfaces/BizCategory)[]
...
> **profileOptions**: [`BizProfileOptions`](/docs/reference/api/model/contact/interfaces/BizProfileOptions)
