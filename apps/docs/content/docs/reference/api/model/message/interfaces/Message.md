...
> **ack**: [`MessageAck`](/docs/reference/api/model/message/enumerations/MessageAck)
...
> `optional` **buttons**: [`Button`](/docs/reference/api/model/button/interfaces/Button)[]
...
> **chat**: [`Chat`](/docs/reference/api/model/chat/type-aliases/Chat)
...
> **from**: [`ChatId`](/docs/reference/api/model/aliases/type-aliases/ChatId)
...
> `optional` **isGroupJoinRequest**: [`GroupChatId`](/docs/reference/api/model/aliases/type-aliases/GroupChatId)
...
> `optional` **listResponse**: [`Row`](/docs/reference/api/model/button/interfaces/Row)
...
> **mentionedJidList**: [`ContactId`](/docs/reference/api/model/aliases/type-aliases/ContactId)[]
...
> `optional` **pollOptions**: [`PollOption`](/docs/reference/api/model/message/interfaces/PollOption)[]
...
> **quoteMap**: [`QuoteMap`](/docs/reference/api/model/message/interfaces/QuoteMap)
...
> `optional` **quotedMsg**: [`Message`](/docs/reference/api/model/message/interfaces/Message)

***

### quotedMsgObj?

> `optional` **quotedMsgObj**: [`Message`](/docs/reference/api/model/message/interfaces/Message)

***

### quotedParentGroupJid?

> `optional` **quotedParentGroupJid**: [`GroupChatId`](/docs/reference/api/model/aliases/type-aliases/GroupChatId)
...
> `optional` **reactionByMe**: [`ReactionSender`](/docs/reference/api/model/message/interfaces/ReactionSender)
...
> **sender**: [`Contact`](/docs/reference/api/model/contact/interfaces/Contact)
...
> **type**: [`MessageTypes`](/docs/reference/api/model/message/enumerations/MessageTypes)
