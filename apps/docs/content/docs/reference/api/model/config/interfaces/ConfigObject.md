...
> **provider**: [`CLOUD_PROVIDERS`](/docs/reference/api/model/config/enumerations/CLOUD_PROVIDERS)
...
> `optional` **devtools**: `boolean` \| [`DevTools`](/docs/reference/api/model/config/interfaces/DevTools)
...
> `optional` **hostNotificationLang**: [`NotificationLanguage`](/docs/reference/api/model/config/enumerations/NotificationLanguage)
...
> `optional` **logging**: [`ConfigLogTransport`](/docs/reference/logging/logging/type-aliases/ConfigLogTransport)[]
...
`true`
> **DANGER:**
> Some features (for example `sendLinkWithAutoPreview`) may not work in every multi-device flow. Validate the capability you depend on against the current client/reference surface before relying on it in production.
...
> `optional` **onError**: [`OnError`](/docs/reference/api/model/config/enumerations/OnError)
...
> `optional` **proxyServerCredentials**: [`ProxyServerCredentials`](/docs/reference/api/model/config/interfaces/ProxyServerCredentials)
...
> `optional` **qrFormat**: [`QRFormat`](/docs/reference/api/model/config/enumerations/QRFormat)
...
> `optional` **qrQuality**: [`QRQuality`](/docs/reference/api/model/config/enumerations/QRQuality)
...
> `optional` **sessionData**: [`Base64`](/docs/reference/api/model/aliases/type-aliases/Base64) \| [`SessionData`](/docs/reference/api/model/config/interfaces/SessionData)
