...
const cli = meow(`
	...
	--ev, -e \t\t\tSend launch events to this URL (includes runtime events if eventMode is on).
	--ef \t\t\t\tFilters which namespaces trigger the webhook set in -e/--ev
	--allow-session-data-wh, -x \tBy default, if you set -e flag, the session data is not transferred to the webhook as it is extremely sensitive data. In order to bypass this security measure, use this flag.
