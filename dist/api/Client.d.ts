...
export declare const getBase64: (url: string, optionsOverride?: any) => Promise<string>;
export declare class Client {
    ...
    sendReplyWithMentions(to: ChatId, content: Contact, replyMessageId: MessageId): Promise<any>;
    ...
    sendImage(to: ChatId, base64: Base64, filename: string, caption: Content, quotedMsgId?: MessageId, waitForId?: boolean, ptt?: boolean): Promise<any>;
    ...
    sendFile(to: ChatId, base64: Base64, filename: string, caption: Content, quotedMsgId?: MessageId, waitForId?: boolean): Promise<any>;
    sendPtt(to: ChatId, base64: Base64, quotedMsgId: MessageId): Promise<any>;
    sendVideoAsGif(to: ChatId, base64: Base64, filename: string, caption: Content, quotedMsgId?: MessageId): Promise<any>;
