...
function retrieveQR(waPage, sessionId, autoRefresh, throwErrorOnTosBlock, qrLogSkip, format, quality) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var qrEv, evalResult, targetElementFound, error_1, qrData, qrCode;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    _a.label = 2;
                case 2:
                    if (!!targetElementFound) return [3, 7];
                    _a.label = 3;
                case 3:
                    _a.trys.push([3, 5, , 6]);
                ...
                case 8:
                    qrData = _a.sent();
                    return [3, 7];
                case 9: return [4, waPage.evaluate("document.querySelector(\"canvas[aria-label='Scan me!']\").toDataURL('image/" + format + "', " + quality + ")")];
                case 10:
                    qrCode = _a.sent();
                    qrEv.emit(qrCode);
                    if (!qrLogSkip)
