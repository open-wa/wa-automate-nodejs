---
id: "connect.Collector"
title: "Class: Collector"
sidebar_label: "Collector"
custom_edit_url: null
---

[connect](/api/modules/connect.md).Collector
...
| Name | Type |
| :------ | :------ |
| `filter` | [`CollectorFilter`](/api/types/connect.CollectorFilter.md)<`any`\> |
...
▸ **addListener**(`eventName`, `listener`): [`Collector`](/api/classes/connect.Collector.md)
...
set by `emitter.setMaxListeners(n)` or defaults to [defaultMaxListeners](/api/classes/connect.Collector.md#defaultmaxlisteners-6).
...
▸ **off**(`eventName`, `listener`): [`Collector`](/api/classes/connect.Collector.md)
...
▸ **on**(`eventName`, `listener`): [`Collector`](/api/classes/connect.Collector.md)
...
▸ **once**(`eventName`, `listener`): [`Collector`](/api/classes/connect.Collector.md)
...
▸ **prependListener**(`eventName`, `listener`): [`Collector`](/api/classes/connect.Collector.md)
...
▸ **prependOnceListener**(`eventName`, `listener`): [`Collector`](/api/classes/connect.Collector.md)
...
▸ **removeAllListeners**(`event?`): [`Collector`](/api/classes/connect.Collector.md)
...
▸ **removeListener**(`eventName`, `listener`): [`Collector`](/api/classes/connect.Collector.md)
...
▸ **setMaxListeners**(`n`): [`Collector`](/api/classes/connect.Collector.md)
